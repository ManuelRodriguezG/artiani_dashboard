                            ...
                            <div id="kt_app_toolbar" class="app-toolbar py-3 py-lg-6">
                                ...
                                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                    ...
                                    <div class="page-title d-flex flex-column justify-content-center flex-wrap me-3">
                                        <!--begin::Title-->
                                        <h1 class="page-heading d-flex text-dark fw-bold fs-3 flex-column justify-content-center my-0">Alta Compra</h1>
                                        <!--end::Title-->
                                        <!--begin::Breadcrumb-->
                                    ...
                                    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                ...
                                                <div class="tab-pane fade show active" id="kt_ecommerce_add_product_general" role="tab-panel">
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        ...
                                                        <div class="card-body pt-0">
                                                            <!--begin::Select2-->
                                                            <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Seleccionar tipo de inventario" id="select_tipo_inventario">
                                                                    ...
                                                                    <div class="d-flex flex-column gap-10">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <table class="table align-middle table-row-dashed fs-6 gy-5">
                                                                                ...
                                                                                <!--end::Table head-->
                                                                                <!--begin::Table body-->
                                                                                <tbody class="fw-semibold text-gray-600" id="kt_ecommerce_edit_order_selected_products">
                                                                                    <!--begin::Empty message-->
                                                                                    <tr class="text-muted">
                                                                                        <td>
                                                                                            <span>Selecciona uno o más productos de la lista con el check list</span>
                                                                                        <td>
                                                                                    </tr>
                                                                                    <!--end::Empty message-->
                                                                                </tbody>
                                            ...
                                            <div class="d-flex justify-content-end">
                                                ...
                                                <!--end::Button-->
                                                <!--begin::Button-->
                                                <a href="javascript:guardar_inventario()" id="kt_ecommerce_guardar_inventario_submit" class="btn btn-primary me-5">Guardar</a>
                                                <!--end::Button-->
                                                <!--begin::Button-->
