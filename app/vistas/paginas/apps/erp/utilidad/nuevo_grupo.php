...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="required form-label">Nombre del grupo</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    <div class="d-flex flex-column gap-10">
                                                                        ...
                                                                        <div>
                                                                            ...
                                                                            <!--begin::Selected products-->
                                                                            <!--begin::Total price-->
                                                                            <div class="fw-bold fs-4">Total Costo: $
                                                                                <span id="kt_ecommerce_edit_order_total_costo">0.00</span>
                                                                            </div>
                                                                            <!--end::Total price-->
                                                                            <!--begin::Total price-->
                                                                            <div class="fw-bold fs-4">Total Precio: $
                                                                                <span id="kt_ecommerce_edit_order_total_precio">0.00</span>
                                                                            </div>
                                                                            <!--end::Total price-->
                                                                            <!--begin::Total price-->
                                                                            <div class="fw-bold fs-4">Ganancia Total: $
                                                                                <span id="kt_ecommerce_edit_order_ganancia_total">0.00</span>
                                                                            </div>
                                                                            <!--end::Total price-->
                                                                            <!--begin::Total price-->
                                                                            <div class="fw-bold fs-4">Porcentaje Ganancia Total:
                                                                                <span id="kt_ecommerce_edit_order_porcentaje_ganancia_total">0.00</span>
                                                                                %
                                                                            </div>
                                                                            <!--end::Total price-->
                                                                        </div>
        ...
        <script src="assets/js/custom/apps/erp/utilidad/utilidad_nuevo_grupo.js"></script>
