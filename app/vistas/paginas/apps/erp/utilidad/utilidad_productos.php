...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                    ...
                                    <div class="card card-flush">
                                        ...
                                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                            ...
                                            <div class="card-title">
                                                ...
                                                <!--end::Search-->
                                                <div id="kt_ecommerce_report_sales_export" class="d-none">
                                                ...
                                                <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                                    ...
                                                    <!--begin::Menu-->
                                                    <div id="kt_ecommerce_report_sales_export_menu" class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-200px py-4" data-kt-menu="true" style="">
                                                        <!--begin::Menu item-->
                                            ...
                                            <div class="row w-100 text-center">
                                                <div class="col-6">
                                                    Porcentaje utilidad anterior:
                                                    <span id="porcentaje_anterior">
                                                       45.6
                                                    </span>
                                                    %
                                                </div>
                                                <div class="col-6">
                                                    Porcentaje utilidad actualizado:
                                                    <span id="porcentaje_actualizado">
                                                       35.2
                                                    </span>
                                                    %
                                                </div>
                                        ...
                                        <div class="card-body pt-0">
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                                ...
                                                <th class="text-end min-w-70px">COSTO</th>
                                                <th class="text-end min-w-70px">PRECIO</th>
                                                <th class="text-end min-w-70px">PROVEEDOR</th>
                                                <th class="text-end min-w-70px">COSTOA</th>
                                                <th class="text-end min-w-70px">PRECIOA</th>
                                                </tr>
                                                <!--end::Table row-->
                                                </thead>
                                                <!--end::Table head-->
        ...
        <script src="assets/js/custom/apps/erp/utilidad/utilidad_mostrar_productos.js"></script>
        <script src="assets/js/custom/apps/erp/utilidad/listing_utilidad_grupo_productos.js"></script>
