...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                ...
                                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <!--end::Menu toggle-->
                                            <!--begin::Menu 1-->
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62fe863133dee">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                ...
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <!--begin::Input-->
                                                        <div>
                                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_62fe863133dee" data-allow-clear="true">
                                                                <option></option>
                                ...
                                <div id="kt_app_content_container" class="app-container">
                                    ...
                                    <div class="card card-flush">
                                        ...
                                        <div class="card-body pt-0">
                                            <!--begin::Table-->
                                            <table class="table align-middle table-row-dashed fs-6 gy-5 compact nowrap" id="kt_ecommerce_sales_table">
                                                <!--begin::Table head-->
                                                <thead>
                                                    <!--begin::Table row-->
                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="text-end min-w-70px">PRODUCTO</th>
                                                        <th class="min-w-100px">PROVEEDOR</th>
                                                        <th class="min-w-175px">SKU</th>
                                                        <th class="text-end min-w-100px">COSTO ANTERIOR</th>
                                                        <th class="text-end min-w-100px">COSTO NUEVO</th>
                                                        <th class="text-end min-w-100px">DIFERENCIA</th>
                                                        <th class="text-end min-w-100px">PRECIO SUGERIDO</th>
                                                        
                                                        <th class="text-end min-w-100px">PORCENTAJE CAMBIO</th>
                                                        <th class="text-end min-w-100px">GANANCIA ANTERIOR</th>
                                                        
                                                        <th class="text-end min-w-100px">PRECIO ACTUAL</th>
                                                        <th class="text-end min-w-100px">PORCENTAJE ACTUAL</th>
                                                        <th class="text-end min-w-100px">INPUT CAMBIO PRECIO</th>
                                                        <th class="text-end min-w-100px">NUEVO PORCENTAJE</th>
                                                        <th class="text-end min-w-100px">NUEVA GANANCIA</th>
                                                ...
                                                <!--end::Table head-->
                                                <!--begin::Table body-->
                                                <tbody class="fw-semibold text-gray-600" id="body-ventas">
        ...
        <script src="assets/js/custom/apps/erp/costos/costo_mostrar_grupos.js"></script>
        <script src="assets/js/custom/apps/erp/costos/listing_costo_grupos.js"></script>
