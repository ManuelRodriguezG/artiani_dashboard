...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                    ...
                                    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html">
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                            ...
                                            <div class="tab-content">                                             
                                                <!--begin::Tab pane-->
                                                <div class="tab-pane fade show active" id="kt_ecommerce_add_product_variantes" role="tab-panel">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_nombre">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_pais">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_ciudad">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_colonia">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_codigo_postal">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_calle">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_numero_exterior">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_numero_interior">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="form-label">Incrustación para mapa</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_incrustado">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                            </div>
        ...
        <script src="assets/js/custom/apps/erp/sucursales/sucursal_alta.js"></script>
