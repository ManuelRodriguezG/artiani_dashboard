 ...
 * Proposito: entrada operativa CMS > Frontend > Marcas.
 * Impacto: permite preparar logos, banners, SEO, orden y destacados de marcas publicas.
 * Contrato: editor local; no escribe BD, no modifica catalogo ERP, precios ni inventario.
 */
$cmsFrontendTitulo = "CMS - Frontend Marcas";
