                                    ...
                                    <div class="tab-content">
                                        ...
                                        <div class="tab-pane fade" id="tab_categorias">
                                            ...
                                            <div class="d-flex flex-column flex-md-row gap-3 mb-5">
                                                ...
                                                <select class="form-select form-select-solid w-md-175px" id="catalogo_categorias_estatus"><option value="">Todo estado</option><option value="activa" selected>Activas</option><option value="inactiva">Inactivas</option></select>
                                            </div>
