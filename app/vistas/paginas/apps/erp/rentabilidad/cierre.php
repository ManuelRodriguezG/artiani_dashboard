...
<head>
    <base href="../../../">
    <title>Rentabilidad - cierre comercial</title>
    <meta charset="utf-8">
                ...
                <div class="d-flex flex-column flex-column-fluid">
                    <div class="app-toolbar py-3 py-lg-6">
                        <div class="app-container container-fluid d-flex flex-stack">
                            <div>
                                <h1 class="page-heading text-dark fw-bold fs-3 mb-1">Rentabilidad - cierre comercial</h1>
                                <span class="text-muted">Prioridades, responsables y checklist antes de cerrar precios</span>
                            </div>
...
<script>
window.RENTABILIDAD_VISTA = "cierre";
