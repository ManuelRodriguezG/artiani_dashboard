...
<head>
    <base href="../../../">
    <title>Rentabilidad - aprobaciones</title>
    <meta charset="utf-8">
                ...
                <div class="d-flex flex-column flex-column-fluid">
                    <div class="app-toolbar py-3 py-lg-6">
                        <div class="app-container container-fluid d-flex flex-stack">
                            <div>
                                <h1 class="page-heading text-dark fw-bold fs-3 mb-1">Rentabilidad - aprobaciones</h1>
                                <span class="text-muted">Preflight, paquetes y aprobaciones internas guardadas</span>
                            </div>
...
<script>
window.RENTABILIDAD_VISTA = "aprobaciones";
