...
<head>
    <base href="../../../">
    <title>Rentabilidad - historial</title>
    <meta charset="utf-8">
                ...
                <div class="d-flex flex-column flex-column-fluid">
                    <div class="app-toolbar py-3 py-lg-6">
                        <div class="app-container container-fluid d-flex flex-stack">
                            <div>
                                <h1 class="page-heading text-dark fw-bold fs-3 mb-1">Rentabilidad - historial</h1>
                                <span class="text-muted">Snapshots recientes y vigencia de evidencia comercial</span>
                            </div>
...
<script>
window.RENTABILIDAD_VISTA = "historial";
