                                                    ...
                                                    <div class="row g-3">
                                                        ...
                                                        <div class="col-12">
                                                            ...
                                                            <div class="d-flex flex-wrap gap-4">
                                                                ...
                                                                <label class="form-check form-check-custom form-check-solid"><input class="form-check-input" type="checkbox" id="alm_cfg_apertura_empaque"><span class="form-check-label">Apertura empaque</span></label>
