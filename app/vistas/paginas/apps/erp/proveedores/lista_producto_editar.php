...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                    ...
                                                    <div class="card card-flush py-4">
                                                        ...
                                                        <div class="card-body pt-0">
                                                            ...
                                                            <div class="mb-10 fv-row">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="price" id="precio_base" class="form-control mb-2" disabled placeholder="Product price" />
                                                                <!--end::Input-->
                                                                <!--begin::Input-->
                                                                <input type="text" name="impuesto" id="porcentaje_impuesto" class="form-control mb-2" placeholder="Porcentaje impuesto" />
                                                                <!--end::Input-->
                                                                <!--begin::Description-->
                                                                ...
                                                                <div class="fv-row">
                                                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                                                        <input class="form-check-input" type="checkbox" value="" id="incluye_impuesto"/>
                                                                        <label class="form-check-label" for="incluye_impuesto">
                                                                            Incluye impuesto
                                                                        </label>
                                                                    </div>
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">
                                                                        Si el producto ya tiene iva incluido
                                                                    </div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                            ...
                                                            <div class="pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="price" id="precio_sin_impuestos" class="form-control mb-2" placeholder="Precio sin impuestos" disabled/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Label-->
                                                                    <label class="required form-label">
                                                                        Precio sugerido
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="price" id="precio_sugerido" class="form-control mb-2" placeholder="Precio sugerido" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingreso el precio del producto</div>
                                                                    <!--end::Description-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="utilidad" id="utlidad_bruta" class="form-control mb-2" placeholder="Porcentaje de utilidad bruta" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Es el porcentaje bruto de utilidad antes de gastos libre de impuestos</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                            </div>
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_unico" id="codigo_unico" class="form-control mb-2" disabled placeholder="Código único" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <div class="d-flex gap-3">
                                                                        <input type="number" name="cantidad" id="cantidad" class="form-control mb-2" disabled placeholder="Cantidad"  />
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <div class="d-flex gap-3">
                                                                        <input type="number" name="cantidad" id="piezas_por_caja" class="form-control mb-2" placeholder="Cantidad" />
                                                                        <!--<input type="number" name="warehouse" class="form-control mb-2" placeholder="In warehouse" />-->
                                                                    </div>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <div class="d-flex gap-3">
                                                                        <input type="number" name="cantidad" id="rotacion" class="form-control mb-2" placeholder="Cantidad" />
                                                                        <!--<input type="number" name="warehouse" class="form-control mb-2" placeholder="In warehouse" />-->
                                                                    </div>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
        ...
        <script src="assets/js/custom/apps/erp/proveedores/proveedores_productos.js"></script>
        <script src="assets/js/custom/apps/erp/proveedores/lista_producto_editar.js"></script>
