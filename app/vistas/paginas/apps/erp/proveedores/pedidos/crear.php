...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                ...
                                <div id="kt_app_content_container" class="app-container container-xxl">
                                    ...
                                    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html">
                                        ...
                                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    <!--begin::Select2-->
                                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="select_establecimientos">
                                                        <option></option>
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="producto_nombre" id="inventario_nombre" class="form-control mb-2" placeholder="Product name"/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="required form-label">Comentario</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <textarea name="inventario_comentario" id="inventario_comentario" class="form-control mb-2"></textarea>
                                            ...
                                            <div class="d-flex justify-content-end">
                                                <!--begin::Button-->
                                                <!--<a href="../../demo1/dist/apps/ecommerce/catalog/products.html" id="kt_ecommerce_add_product_cancel" class="btn btn-danger me-5">Cancel</a>-->
                                                <!--end::Button-->
                                                <!--begin::Button-->
                                                <a href="javascript:guardar_pedido()" id="kt_ecommerce_guardar_inventario_submit" class="btn btn-primary me-5">Guardar</a>
                                                <!--end::Button-->
                                                <!--begin::Button-->
                                                <!--<a href="javascript:afectar_inventario()" id="kt_ecommerce_guardar_inventario_submit" class="btn btn-success me-5">Afectar</a>-->
                                                <!--end::Button-->
                                            </div>
                                        </div>
                                        <!--end::Main column-->
        ...
        <script src="assets/js/custom/apps/erp/proveedores/pedidos/pedidos.js"></script>
