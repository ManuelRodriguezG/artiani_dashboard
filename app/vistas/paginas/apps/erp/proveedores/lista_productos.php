...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                    ...
                                    <div class="card card-flush">
                                        ...
                                        <div class="card-header align-items-center py-5 gap-2 gap-md-5">
                                            ...
                                            <div class="card-toolbar flex-row-fluid justify-content-end gap-5">
                                                ...
                                                <!--begin::Add product-->
                                                <a href="javascript:generar_orden_de_compra();" class="btn btn-primary">Orden de compra</a>
                                                <!--end::Add product-->
                                            </div>
                                            <!--end::Card toolbar-->
                                        </div>
                                            ...
                                            <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_sales_table">
                                                ...
                                                <thead>
                                                    ...
                                                    <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                        ...
                                                        <th class="text-end min-w-70px">EXIS</th>
                                                        <th class="text-end min-w-70px">COSTO</th>
                                                        <th class="text-end min-w-70px">PC</th>
                                                        <th class="text-end min-w-70px">ROT</th>
                                                        <th class="text-center min-w-70px">CANT</th>
        ...
        <script src="assets/js/custom/apps/erp/proveedores/lista_productos.js"></script>
        <script src="assets/js/custom/apps/erp/proveedores/listing_lista_productos.js"></script>
