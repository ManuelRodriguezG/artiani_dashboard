...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                ...
                                <div id="kt_app_toolbar_container" class="app-container container-xxl d-flex flex-stack">
                                    ...
                                    <div class="d-flex align-items-center gap-2 gap-lg-3">
                                        ...
                                        <div class="m-0">
                                            ...
                                            <!--end::Menu toggle-->
                                            <!--begin::Menu 1-->
                                            <div class="menu menu-sub menu-sub-dropdown w-250px w-md-300px" data-kt-menu="true" id="kt_menu_62fe86336f4a0">
                                                <!--begin::Header-->
                                                <div class="px-7 py-5">
                                                ...
                                                <div class="px-7 py-5">
                                                    ...
                                                    <div class="mb-10">
                                                        ...
                                                        <!--begin::Input-->
                                                        <div>
                                                            <select class="form-select form-select-solid" data-kt-select2="true" data-placeholder="Select option" data-dropdown-parent="#kt_menu_62fe86336f4a0" data-allow-clear="true">
                                                                <option></option>
                                    ...
                                    <form id="kt_ecommerce_edit_order_form" class="form d-flex flex-column flex-lg-row" data-kt-redirect="../../demo1/dist/apps/ecommerce/sales/listing.html">                                        
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="d-flex flex-column gap-10">
                                                        ...
                                                        <div class="fv-row">
                                                            <!--begin::Label-->
                                                            <label class="form-label">Venta Identificador</label>
                                                            <!--end::Label-->
                                                            <!--begin::Auto-generated ID-->
                                                            <div class="fw-bold fs-3" id="identificador_pedido">#13059</div>
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        <div class="fv-row">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Auto-generated ID-->
                                                            <div class="fw-bold fs-3" id="medio_comunicacion"></div>
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        <div class="fv-row">
                                                            <!--begin::Label-->
                                                            <label class="required form-label">Tipo de Entrega</label>
                                                            <!--end::Label-->
                                                            <!--begin::Select2-->
                                                            <select id="tipos_entrega" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" name="tipo_entrega" id="kt_ecommerce_edit_order_shipping">
                                                        ...
                                                        <div class="fv-row">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Editor-->
                                                            <input id="pedido_fecha" name="pedido_fecha" placeholder="Selecciona la fecha" class="form-control mb-2"/>
                                                            <!--end::Editor-->
                                                            <!--begin::Description-->
                                                            <div class="text-muted fs-7">Ingresa la fecha de entrega</div>
                                                            <!--end::Description-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        <div class="fv-row">
                                                            <!--begin::Label-->
                                                            <label class="required form-label">Hora de entrega</label>
                                                            <!--end::Label-->
                                                            <!--begin::Editor-->
                                                            <input id="pedido_hora" name="pedido_hora" placeholder="Seleccionar hora" class="form-control mb-2"/>
                                                            <!--end::Editor-->
                                                            <!--begin::Description-->
                                                            <div class="text-muted fs-7">Ingresa la hora de entrega</div>
                                                            <!--end::Description-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        <div class="fv-row">
                                                            <!--begin::Label-->
                                                            <label class="required form-label">Costo de envío</label>
                                                            <!--end::Label-->
                                                            <!--begin::Editor-->
                                                            <input id="pedido_envio" onfocusout="agregar_envio();" name="pedido_envio" placeholder="Ingreso costo de envío" class="form-control mb-2" />
                                                            <!--end::Editor-->
                                                            <!--begin::Description-->
                                                            <!--<div class="text-muted fs-7">Set the date of the order to process.</div>-->
                                                            <!--end::Description-->
                                                        ...
                                                        <div class="fv-row">
                                                            ...
                                                            <!--end::Label-->
                                                            <!--begin::Editor-->
                                                            <input id="pedido_descuento" onfocusout="agregar_descuento();" name="pedido_descuento" placeholder="Ingreso el descuento" class="form-control mb-2" />
                                                            <!--end::Editor-->
                                                            <!--begin::Description-->
                                                            <!--<div class="text-muted fs-7">Set the date of the order to process.</div>-->
                                                            <!--end::Description-->
                                        ...
                                        <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="d-flex flex-column gap-10">
                                                        ...
                                                        <div>
                                                            <!--begin::Label-->
                                                            <label class="form-label">Agregar productos para la venta</label>
                                                            <!--end::Label-->
                                                            ...
                                                            <div class="row row-cols-1 row-cols-xl-3 row-cols-md-2 border border-dashed rounded pt-3 pb-1 px-2 mb-5 mh-300px overflow-scroll" id="kt_ecommerce_edit_order_selected_products">
                                                                <!--begin::Empty message-->
                                                                <span class="w-100 text-muted">Selecciona uno o más producctos de la lista con el check list</span>
                                                                <!--end::Empty message-->
                                                            </div>
                                                            <!--begin::Selected products-->
                                                            <!--begin::Total price-->
                                                            <div class="fw-bold fs-4">Subtotal: $
                                                                <span id="kt_ecommerce_edit_order_subtotal_price">0.00</span>
                                                            </div>
                                                            <!--end::Total price-->
                                                            <!--begin::Total price-->
                                                            <div class="fw-bold fs-4">Descuento: $
                                                                <span id="kt_ecommerce_edit_order_descuento_price">0.00</span>
                                                            </div>
                                                            <!--end::Total price-->
                                                            <!--begin::Total price-->
                                                            <div class="fw-bold fs-4">Envío: $
                                                                <span id="kt_ecommerce_edit_order_envio_price">0.00</span>
                                                            </div>
                                                            <!--end::Total price-->
                                                            <!--begin::Total price-->
                                                            <div class="fw-bold fs-4">Iva: $
                                                                <span id="kt_ecommerce_edit_order_iva_price">0.00</span>
                                                            </div>
                                                            <!--end::Total price-->
                                                            <!--begin::Total price-->
                                                        ...
                                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_edit_order_product_table">
                                                            ...
                                                            <!--end::Table head-->
                                                            <!--begin::Table body-->
                                                            <tbody class="fw-semibold text-gray-600" id="pedido_productos">
                                                                <!--begin::Table row-->
                                                                <tr>
                                                                    <!--begin::Checkbox-->
                                                                    <td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_1">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 04426006</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_2">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03490008</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_3">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03296006</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_4">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 04480006</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_6">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 02221004</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_7">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 02965002</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_8">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 02332009</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_9">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 01965005</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_10">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03884007</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_11">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 02748003</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_12">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 04651005</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_13">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 01469004</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_14">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 01344006</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_15">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 04659008</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_16">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 01786006</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_17">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03457009</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_18">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03549004</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_19">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 02683001</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_20">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03877007</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_21">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03612003</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_22">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 01352005</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_24">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03820008</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_25">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 04452003</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_26">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 02899002</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_27">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 02144003</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_28">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03593009</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_29">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 02887008</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                                                    ...
                                                                    <td>
                                                                        <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-kt-ecommerce-edit-order-id="product_30">
                                                                            ...
                                                                            <div class="ms-5">
                                                                                ...
                                                                                <!--begin::Price-->
                                                                                <div class="fw-semibold fs-7">Price: $
                                                                                    <span data-kt-ecommerce-edit-order-filter="price">204.00</span></div>
                                                                                <!--end::Price-->
                                                                                <!--begin::SKU-->
                                                                                <div class="text-muted fs-7">SKU: 03187005</div>
                                                                                <!--end::SKU-->
                                                                            </div>
                                                                        </div>
                                                                    </td>
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                                        <!--begin::Label-->
                                                        <label class="form-label">Agregar método de pago</label>
                                                        <!--end::Label-->
                                                        <!--begin::Repeater-->
                                                        <div id="kt_ecommerce_add_product_options">
                                                            <!--begin::Form group-->
                                                            <div class="form-group">
                                                                <div data-repeater-list="" id="repeat-list-pagos" class="d-flex flex-column gap-3">
                                                                    <div data-repeater-item="" class="form-group d-flex flex-wrap align-items-center gap-5 contenedor-pago">
                                                                        ...
                                                                        <!--end::Select2-->
                                                                        <!--begin::Input-->
                                                                        <input type="text" class="form-control mw-100 w-200px input-cantidad" name="product_option_value" placeholder="Cantidad" />
                                                                        <!--end::Input-->
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="d-flex flex-column gap-5 gap-md-7">
                                                        <!--begin::Title-->
                                                        <!--<div class="fs-3 fw-bold mb-n2">Nombre del cliente</div>-->
                                                        <!--end::Title-->
                                                        <!--begin::Input group-->
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="fv-row flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_apellido_paterno" id="cliente_apellido_paterno" placeholder="Apellido Paterno"/>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_apellido_materno" id="cliente_apellido_materno" placeholder="Apellido Materno"/>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_nombres" id="cliente_nombres" placeholder="Nombre(s) del cliente"/>
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_contacto_primero" id="cliente_contacto_primero" placeholder="Primer contacto"/>
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid">
                                                                <!--begin::Label-->
                                                                <label class="required form-label">Contacto 2</label>
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_contacto_segundo" id="cliente_contacto_segundo" placeholder="Segundo contacto"/>
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            ...
                                                            <label class="form-check-label" for="same_as_billing">Facturar</label>
                                                        </div>
                                                        <!--end::Checkbox-->
                                                        <!--begin::Shipping address-->
                                                        <div class="d-none d-flex flex-column gap-5 gap-md-7" id="kt_ecommerce_edit_order_shipping_form">
                                                            <!--begin::Title-->
                                                            <div class="fs-3 fw-bold mb-n2">Datos Fiscales</div>
                                                            <!--end::Title-->
                                                            <!--begin::Input group-->
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_uso_cfdi" id="fiscal_uso_cfdi" placeholder="Uso cfdi"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_regimen" id="fiscal_regimen" placeholder="Régimen Fiscal"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_rfc" id="fiscal_rfc" placeholder="RFC"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_razon_social" id="fiscal_razon_social" placeholder="Razón Social"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <div class="flex-row-fluid">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_estado" id="fiscal_estado" placeholder="Estado"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="fv-row flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_ciudad" id="fiscal_ciudad" placeholder="Ciudad o Municipio"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="fv-row flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_colonia" id="fiscal_colonia" placeholder="Colonia"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_calle" id="fiscal_calle" placeholder="Calle"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_numero_exterior" id="fiscal_numero_exterior" placeholder="Número exterior"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_numero_interior" id="fiscal_numero_interior" placeholder="Número interior"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="fv-row flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_codigo_postal" id="fiscal_codigo_postal" placeholder="Código Postal"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                            </div>
                                                            <!--end::Input group-->
                                                    ...
                                                    <div class="d-flex flex-column gap-5 gap-md-7">
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                                <!--begin::Select2-->
                                                                <select onchange="select_puntos_entrega(this);" id="puntos_entrega" class="form-select mb-2 d-none" data-control="select2" data-hide-search="true" data-placeholder="Select an option" name="puntos_entrega">
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_estado" id="venta_estado" placeholder="Estado">
                                                                <!--end::Input-->
                                                            ...
                                                            <div class="flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_ciudad" id="venta_ciudad">
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_colonia" id="venta_colonia" placeholder="Colonia" >
                                                                <!--end::Input-->
                                                                <div class="fv-plugins-message-container invalid-feedback">
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_calle" id="venta_calle" placeholder="Calle">
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_numero_exterior" id="venta_numero_exterior" placeholder="Número exterior">
                                                                <!--end::Input-->
                                                                <div class="fv-plugins-message-container invalid-feedback">
                                                            ...
                                                            <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_numero_interior" id="venta_numero_interior" placeholder="Número interior" value="">
                                                                <!--end::Input-->
                                                                <div class="fv-plugins-message-container invalid-feedback">
                                                            ...
                                                            <div class="fv-row flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_codigo_postal" id="venta_codigo_postal" placeholder="Código Postal">
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <textarea class="form-control" name="venta_referencias" id="venta_referencias" placeholder="Referencias" value=""></textarea>
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                    </div>
                                            ...
                                            <div class="d-flex justify-content-end">
                                                ...
                                                <!--end::Button-->
                                                <!--begin::Button-->
                                                <button id="kt_ecommerce_edit_order_submit" class="btn btn-primary">
        ...
        <script src="SYS/select/select.js"></script>
        <script src="assets/js/custom/apps/ecommerce/catalog/productos.js"></script>
        <script src="assets/js/custom/apps/sistema/metodos_pago.js"></script>
        <script src="assets/js/custom/apps/sistema/tipos_entrega.js"></script>
        <script src="assets/js/custom/apps/ecommerce/sales/ventas.js"></script>
        <script src="assets/js/custom/apps/ecommerce/sales/editar-venta.js"></script>
