...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                ...
                                                <div class="card-body pt-0">
                                                    <div class="d-flex flex-column gap-10">
                                                        ...
                                                        <div class="fv-row">
                                                            ...
                                                            <div class="fw-bold fs-3">#13059</div>
                                                            <!--end::Input-->
                                                        </div>
                                                        <!--end::Input group-->
                                                        <!--begin::Input group-->
                                                        ...
                                                        <div class="fv-row">
                                                            <!--begin::Label-->
                                                            <label class="required form-label">Estatus del Pedido</label>
                                                            <!--end::Label-->
                                                            <!--begin::Select2-->
                                                            <select id="estatus_pedido" class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" name="tipo_entrega" id="kt_ecommerce_edit_order_shipping">
                                                        ...
                                                        <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_edit_order_product_table">
                                                            ...
                                                            <thead>
                                                                <tr class="text-start text-gray-400 fw-bold fs-7 text-uppercase gs-0">
                                                                    ...
                                                                    <th class="min-w-100px text-end pe-5">Cantidad</th>
                                                    ...
                                                    <div class="" data-kt-ecommerce-catalog-add-product="auto-options">
                                                        ...
                                                        <div id="kt_ecommerce_add_product_options">
                                                            ...
                                                            <div class="form-group">
                                                                <div data-repeater-list="" class="d-flex flex-column gap-3">
                                                    ...
                                                    <div class="d-flex flex-column gap-5 gap-md-7">
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="fv-row flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_apellido_paterno" id="cliente_apellido_paterno" placeholder="Apellido Paterno" value="Rodríguez" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_apellido_materno" id="cliente_apellido_materno" placeholder="Apellido Materno" value="Gutiérrez" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_nombres" id="cliente_nombres" placeholder="Nombre(s) del cliente" value="Manuel Alejandro" />
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_contacto_primero" id="cliente_contacto_primero" placeholder="Primer contacto" value="3336372508" />
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="cliente_contacto_segundo" id="cliente_contacto_segundo" placeholder="Segundo contacto" value="3322068429" />
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        ...
                                                        <!--begin::Checkbox-->
                                                        <div class="form-check form-check-custom form-check-solid">
                                                            <input class="form-check-input" type="checkbox" value="" id="publico_general"/>
                                                            <label class="form-check-label" for="publico_general">Público en general</label>
                                                        </div>
                                                        <!--end::Checkbox-->
                                                        ...
                                                        <div class="d-none d-flex flex-column gap-5 gap-md-7" id="kt_ecommerce_edit_order_shipping_form">
                                                            ...
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_uso_cfdi" id="fiscal_uso_cfdi" placeholder="Uso cfdi" value="Gastos en general" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_regimen" id="fiscal_regimen" placeholder="Régimen Fiscal" value="Personas Fisicas con Actividad Empresarial"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_rfc" id="fiscal_rfc" placeholder="RFC" value="ROGM9604248P5" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_razon_social" id="fiscal_razon_social" placeholder="Razón Social" value="Manuel Alejandro Rodriguez Gutierrez"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <div class="flex-row-fluid">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_estado" id="fiscal_estado" placeholder="Estado" value="Jalisco" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="fv-row flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_ciudad" id="fiscal_ciudad" placeholder="Ciudad o Municipio" value="Guadalajara" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="fv-row flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_colonia" id="fiscal_colonia" placeholder="Colonia" value="Oblatos" />
                                                                    <!--end::Input-->
                                                                </div>
                                                            </div>
                                                            <!--end::Input group-->
                                                            ...
                                                            <div class="d-flex flex-column flex-md-row gap-5">
                                                                <div class="fv-row flex-row-fluid">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_calle" id="fiscal_calle" placeholder="Calle" value="Francisco Javier Mina" />
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_numero_exterior" id="fiscal_numero_exterior" placeholder="Número exterior" value="967"/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_numero_interior" id="fiscal_numero_interior" placeholder="Número interior" value=""/>
                                                                    <!--end::Input-->
                                                                </div>
                                                                <div class="fv-row flex-row-fluid">
                                                                    <!--begin::Label-->
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input class="form-control" name="fiscal_codigo_postal" id="fiscal_codigo_postal" placeholder="Código Postal" value="44700" />
                                                                    <!--end::Input-->
                                                                </div>
                                                            </div>
                                                            <!--end::Input group-->
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <div class="d-flex flex-column gap-5 gap-md-7">
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            ...
                                                            <div class="fv-row">
                                                                <!--begin::Label-->
                                                                <label class="required form-label">Hora de entrega inicial</label>
                                                                <!--end::Label-->
                                                                <!--begin::Editor-->
                                                                <input id="pedido_hora_inicial" name="pedido_hora_inicial" placeholder="Seleccionar hora" class="form-control mb-2"/>
                                                                <!--end::Editor-->
                                                                <!--begin::Description-->
                                                            ...
                                                            <div class="fv-row">
                                                                <!--begin::Label-->
                                                                <label class="form-label">Hora de entrega final</label>
                                                                <!--end::Label-->
                                                                <!--begin::Editor-->
                                                                <input id="pedido_hora_final" name="pedido_hora_final" placeholder="Seleccionar hora" class="form-control mb-2"/>
                                                                <!--end::Editor-->
                                                                <!--begin::Description-->
                                                                <div class="text-muted fs-7">Ingresa la hora de entrega</div>
                                                                <!--end::Description-->
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_estado" id="venta_estado" placeholder="Estado" value="Jalisco">
                                                                <!--end::Input-->
                                                            ...
                                                            <div class="flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_ciudad" id="venta_ciudad" placeholder="Ciudad o municipio">
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_colonia" id="venta_colonia" placeholder="Colonia" value="Guadalajara">
                                                                <!--end::Input-->
                                                                <div class="fv-plugins-message-container invalid-feedback">
                                                        ...
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_calle" id="venta_calle" placeholder="Calle" value="Francisco Javier Mina">
                                                                <!--end::Input-->
                                                            </div>
                                                            <div class="fv-row flex-row-fluid fv-plugins-icon-container">
                                                                <!--begin::Label-->
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_numero_exterior" id="venta_numero_exterior" placeholder="Número exterior" value="967">
                                                                <!--end::Input-->
                                                                <div class="fv-plugins-message-container invalid-feedback">
                                                            ...
                                                            <div class="fv-row flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <input class="form-control" name="venta_codigo_postal" id="venta_codigo_postal" placeholder="Código Postal" value="44700">
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                        <!--end::Input group-->
                                                        <div class="d-flex flex-column flex-md-row gap-5">
                                                            <div class="flex-row-fluid">
                                                                ...
                                                                <!--end::Label-->
                                                                <!--begin::Input-->
                                                                <textarea class="form-control" name="venta_referencias" id="venta_referencias" placeholder="Referencias" value="">Entre Francisco Sarabia y Avenida de la paz</textarea>
                                                                <!--end::Input-->
                                                            </div>
                                                        </div>
                                                    </div>
        ...
        <!--begin::Modal - Invite Friends-->
        <div class="modal fade" id="kt_modal_cambiar_precio" data-backdrop="static" data-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
            <!--begin::Modal dialog-->
            <div class="modal-dialog mw-650px">
                <!--begin::Modal content-->
                <div class="modal-content">
                    ...
                    <div class="modal-body scroll-y mx-5 mx-xl-18 pt-0 pb-15">
                        <!--begin::Heading-->
                        <div class="text-center mb-13">
                            <input class="form-control" id="cambiar_precio_nuevo">
                        </div>
                        <div style="text-align:right;">
                            <button type="button" class="btn btn-lg btn-primary boton-modificar-precio" data-kt-stepper-action="next" onclick="modificar_precio_producto(this);">
                                Modificar
                                <!--begin::Svg Icon | path: icons/duotune/arrows/arr064.svg-->
                                <span class="svg-icon svg-icon-3 ms-1 me-0">
                                    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        <script src="assets/js/custom/apps/erp/ventas/ventas.js"></script>
