...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_titulo">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                ...
                                                                <!--end::Input group-->
                                                                <a href="javascript:agregar_variante();" id="kt_ecommerce_add_attribute" class="btn btn-primary me-5">Agregar Producto</a>
                                                                <div>
        ...
        <script src="assets/js/custom/apps/customers/fotos_clientes_productos.js"></script>
