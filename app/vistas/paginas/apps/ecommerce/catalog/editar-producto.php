...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                        ...
                        <div class="d-flex flex-column flex-column-fluid">
                            ...
                            <div id="kt_app_content" class="app-content flex-column-fluid">
                                ...
                                <div id="kt_app_content_container" class="app-container container-xxl">
                                    <!--begin::Form-->
                                    <form id="kt_ecommerce_add_product_form" class="form d-flex flex-column flex-lg-row" enctype="multipart/form-data" data-kt-redirect="../../demo1/dist/apps/ecommerce/catalog/products.html">
                                        <!--begin::Aside column-->
                                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    <!--begin::Select2-->
                                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="select_categorias" multiple="multiple">
                                                        <option></option>
                                                ...
                                                <div class="card-body pt-0">
                                                    <!--begin::Select2-->
                                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="select_proveedores" multiple="multiple">
                                                        <option></option>
                                                        <option value="published" selected="selected">Published</option>
                                                        <option value="draft">Draft</option>
                                                        <option value="scheduled">Scheduled</option>
                                                ...
                                                <div class="card-body pt-0">
                                                    <!--begin::Select2-->
                                                    <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="select_marcas" multiple="multiple">
                                                        <option></option>
                                                        <option value="published" selected="selected">Published</option>
                                                        <option value="draft">Draft</option>
                                                        <option value="scheduled">Scheduled</option>
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <!--end::Input-->
                                                    <!--begin::Description-->
                                                    <div class="text-muted fs-7"> Agrega filtros para este producto.</div>
                                                    <!--end::Description-->
                                                    <!--end::Input group-->
                                                </div>
                                                <!--end::Card body-->
                                        ...
                                        <div class="d-flex flex-column flex-row-fluid gap-7 gap-lg-10">
                                            ...
                                            <ul class="nav nav-custom nav-tabs nav-line-tabs nav-line-tabs-2x border-0 fs-4 fw-semibold mb-n2">
                                                ...
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_advanced">Inventario</a>
                                                </li>
                                                <!--end:::Tab item-->
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_compra_venta">Compra - Venta</a>
                                                </li>
                                                <!--end:::Tab item-->
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_atributos">Atributos</a>
                                                </li>
                                                <!--end:::Tab item-->
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_variantes">Variantes</a>
                                                </li>
                                                <!--end:::Tab item-->
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_sugeridos">Sugeridos</a>
                                                </li>
                                                <!--end:::Tab item-->
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_complementos">Complementos</a>
                                                </li>
                                                <!--end:::Tab item-->
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_etiquetas">Etiquetas</a>
                                                </li>
                                                <!--end:::Tab item-->
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_utilidad">Utilidad</a>
                                                </li>
                                                <!--end:::Tab item-->
                                                <!--begin:::Tab item-->
                                                <li class="nav-item">
                                                    <a class="nav-link text-active-primary pb-4" data-bs-toggle="tab" href="#kt_ecommerce_add_product_envios">Envíos</a>
                                                </li>
                                                <!--end:::Tab item-->
                                            </ul>
                                            <!--end:::Tabs-->
                                            ...
                                            <div class="tab-content">
                                                    ...
                                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="producto_nombre" id="producto_nombre" class="form-control mb-2" placeholder="Product name" value="Sample product" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                ...
                                                                <div class="fv-row">
                                                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                                                        <input class="form-check-input" type="checkbox" value="" id="siempre_disponible"/>
                                                                        <label class="form-check-label" for="siempre_disponible">
                                                                            Disponible
                                                                        </label>
                                                                    </div>
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">
                                                                        Mostrar producto siempre disponible
                                                                    </div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <!--end::Input group-->
                                                                <!--begin::Description-->
                                                                <div class="text-muted fs-7">Agrega imagenes de productos</div>
                                                                <!--end::Description-->
                                                                <div class="row" id="galeria-imagenes-producto">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="price" id="precio_base" class="form-control mb-2" placeholder="Precio base" value="124" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingreso el precio del producto</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="price" id="precio_oferta" class="form-control mb-2" placeholder="Precio oferta" value="124" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa un precio menor al precio base</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                            </div>
                                                    ...
                                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="required form-label">Código proveedor</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_unico" id="codigo_unico" class="form-control mb-2" placeholder="Código único" value="ZHK-123" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa el código único del producto</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="required form-label">Código interno</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_interno" id="codigo_interno" class="form-control mb-2" placeholder="Código único" value="ZHK-123" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa el código único del producto</div>
                                                                    <!--end::Description-->
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_barras" id="codigo_barras" class="form-control mb-2" placeholder="Código de barras" value="0987654321" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa el codigo de barras del producto</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <div class="d-flex gap-3">
                                                                        <input type="number" name="minima_existencia" id="minima_existencia" class="form-control mb-2" placeholder="Mínima existencia" value="0"/>
                                                                        <!--<input type="number" name="warehouse" class="form-control mb-2" placeholder="In warehouse" />-->
                                                                    </div>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa la cantidad mínima de productos que desea tener en existencia</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <div class="d-flex gap-3">
                                                                        <input type="number" name="maxima_existencia" id="maxima_existencia" class="form-control mb-2" placeholder="Máxima existencia" value="0""/>
                                                                        <!--<input type="number" name="warehouse" class="form-control mb-2" placeholder="In warehouse" />-->
                                                                    </div>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa la cantidad máxima de productos que desea tener en existencia</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <div class="d-flex gap-3">
                                                                        <input type="number" name="cantidad" id="cantidad" class="form-control mb-2" placeholder="Cantidad"/>
                                                                        <!--<input type="number" name="warehouse" class="form-control mb-2" placeholder="In warehouse" />-->
                                                                    </div>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa la cantidad de productos</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                ...
                                                <!--end::Tab pane-->
                                                <!--begin::Tab pane-->
                                                <div class="tab-pane fade" id="kt_ecommerce_add_product_compra_venta" role="tab-panel">
                                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                                        <!--begin::Inventory-->
                                                        <div class="card card-flush py-4">
                                                            <!--begin::Card header-->
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <select class="form-select mb-2" onchange="ui_unidades_venta();" id="unidad_compra" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <select class="form-select mb-2" id="unidad_venta" data-control="select2" data-placeholder="Select an option" data-allow-clear="true">
                                                                        <option value="-1">
                                                                            Selecciona unidad de venta
                                                                        </option>
                                                                    </select>
                                                                    <!--end::Select2-->
                                                                </div>
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="form-label">Factor de venta</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="number" id="factor_compra" min="0" value="1" disabled="disabled">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="fv-row">
                                                                    <div class="form-check form-switch form-check-custom form-check-solid">
                                                                        <input class="form-check-input" type="checkbox" disabled="disabled" id="solo_en_punto_de_venta"/>
                                                                        <label class="form-check-label" for="solo_en_punto_de_venta">
                                                                            Solo en punto de venta
                                                                        </label>
                                                                    </div>
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">
                                                                        Verder a granel solo en punto de venta
                                                                    </div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                ...
                                                <!--end::Tab pane-->
                                                <!--begin::Tab pane-->
                                                <div class="tab-pane fade" id="kt_ecommerce_add_product_atributos" role="tab-panel">
                                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                                        <!--begin::Inventory-->
                                                        <div class="card card-flush py-4">
                                                            <!--begin::Card header-->
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="form-label">Tipo Atributo</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="tipo_atributo">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="form-label">Valor Atributo</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="valor_atributo">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="unidad_medida_atributo">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="descripcion_atributo">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <a href="javascript:agregar_atributo();" id="kt_ecommerce_add_attribute" class="btn btn-primary me-5">Agregar atributo</a>
                                                                <div>
                                                ...
                                                <!--end::Tab pane-->
                                                <!--begin::Tab pane-->
                                                <div class="tab-pane fade" id="kt_ecommerce_add_product_variantes" role="tab-panel">
                                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                                        <!--begin::Inventory-->
                                                        <div class="card card-flush py-4">
                                                            <!--begin::Card header-->
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="form-label">ID producto variante</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="id_variante">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Select2-->
                                                                    <input class="form-control mb-2" type="text" id="principal">
                                                                    <!--end::Select2-->
                                                                </div>
                                                                <!--end::Input group-->

                                                                <a href="javascript:agregar_variante();" id="kt_ecommerce_add_attribute" class="btn btn-primary me-5">Agregar Variante</a>
                                                                <div>
                                                                    <table style="width: 100%;">
                                                                        <thead>
                                                                            <tr>
                                                ...
                                                <!--end::Tab pane-->
                                                <!--begin::Tab pane-->
                                                <div class="tab-pane fade" id="kt_ecommerce_add_product_sugeridos" role="tab-panel">
                                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                                        <!--begin::Inventory-->
                                                        <div class="card card-flush py-4">
                                                            <!--begin::Card header-->
                                                                ...
                                                                <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                                                                    ...
                                                                    <div class="card card-flush py-4">
                                                                        ...
                                                                        <div class="card-body pt-0">
                                                                            ...
                                                                            <div class="mb-10 fv-row">
                                                                                <!--begin::Label-->
                                                                                <label class="form-label">ID producto sugerido</label>
                                                                                <!--end::Label-->
                                                                                <!--begin::Select2-->
                                                                                <input class="form-control mb-2" type="text" id="id_kt_ecommerce_add_producto_sugerido">
                                                                                <!--end::Select2-->
                                                                            </div>
                                                                            <!--end::Input group-->
                                                                            <a href="javascript:void(0)" onclick="agregar_sugerido_complemento(this);" id="kt_ecommerce_add_producto_sugerido" class="btn btn-primary me-5">Agregar Variante</a>
                                                                            <div>
                                                                                <table style="width: 100%;">
                                                                                    <thead>
                                                                                        <tr>
                                                                                    ...
                                                                                    <tbody id="body_kt_ecommerce_add_producto_sugerido">
                                                                                    </tbody>
                                                                                </table>
                                                                            </div>
                                                                        </div>
                                                ...
                                                <!--end::Tab pane-->
                                                <!--begin::Tab pane-->
                                                <div class="tab-pane fade" id="kt_ecommerce_add_product_complementos" role="tab-panel">
                                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                                        <!--begin::Inventory-->
                                                        <div class="card card-flush py-4">
                                                            <!--begin::Card header-->
                                                                ...
                                                                <div class="d-flex flex-column flex-lg-row-fluid gap-7 gap-lg-10">
                                                                    ...
                                                                    <div class="card card-flush py-4">
                                                                        ...
                                                                        <div class="card-body pt-0">
                                                                            ...
                                                                            <div class="mb-10 fv-row">
                                                                                <!--begin::Label-->
                                                                                <label class="form-label">ID producto complementario</label>
                                                                                <!--end::Label-->
                                                                                <!--begin::Select2-->
                                                                                <input class="form-control mb-2" type="text" id="id_kt_ecommerce_add_producto_complementario">
                                                                                <!--end::Select2-->
                                                                            </div>
                                                                            <!--end::Input group-->
                                                                            <a href="javascript:void(0)" onclick="agregar_sugerido_complemento(this);" id="kt_ecommerce_add_producto_complementario" class="btn btn-primary me-5">Agregar Variante</a>
                                                                            <div>
                                                                                <table style="width: 100%;">
                                                                                    <thead>
                                                                                        <tr>
                                                                                    ...
                                                                                    <tbody id="body_kt_ecommerce_add_producto_complementario">
                                                                                    </tbody>
                                                                                </table>
                                                                            </div>
                                                                        </div>
                                                    ...
                                                    <!--end::Tab pane-->
                                                    <!--begin::Tab pane-->
                                                    <div class="tab-pane fade" id="kt_ecommerce_add_product_utilidad" role="tab-panel">
                                                        <div class="d-flex flex-column gap-7 gap-lg-10">
                                                            <!--begin::Inventory-->
                                                            <div class="card card-flush py-4">
                                                                <!--begin::Card header-->
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    ...
                                                                    <div class="mb-10 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="required form-label">Costo proveedor(es)</label>
                                                                        <!--end::Label-->
                                                                        <div style="margin-left: 1rem;">
                                                                            <!--begin::Label-->
                                                                            <label class="required form-label">proveedor 1</label>
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="text" name="costo_proveedor_1" class="form-control mb-2" placeholder="Costo proveedor"/>
                                                                            <!--end::Input-->
                                                                        </div>
                                                                    </div>
                                                                    <!--end::Input group-->
                                                                    ...
                                                                    <div class="mb-10 fv-row">
                                                                        ...
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input type="text" name="precio_venta" id="precio_venta" class="form-control mb-2" placeholder="Precio venta" />
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <!--end::Input group-->
                                                                    <!--begin::Input group-->
                                                                    <div class="mb-10 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="required form-label">Utilidad bruta</label>
                                                                        <!--end::Label-->
                                                                        <div style="margin-left: 1rem;">
                                                                            <!--begin::Label-->
                                                                            <label class="required form-label">Utilidad bruta 1</label>
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="text" name="utilidad_bruta" class="form-control mb-2" placeholder="Utilidad bruta" />
                                                                            <!--end::Input-->
                                                                        </div> 
                                                                    </div>
                                                                    <!--end::Input group-->
                                                                    ...
                                                                    <div class="mb-10 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="required form-label">Porcentaje gastos</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input type="text" name="precio_venta" id="precio_venta" class="form-control mb-2" placeholder="Precio venta" />
                                                                        <!--end::Input-->
                                                                    ...
                                                                    <div class="mb-10 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="required form-label">Utilidad final</label>
                                                                        <!--end::Label-->
                                                                        <div style="margin-left: 1rem;">
                                                                            <!--begin::Label-->
                                                                            <label class="required form-label">Utilidad final 1</label>
                                                                            <!--end::Label-->
                                                                            <!--begin::Input-->
                                                                            <input type="text" name="utilidad_final" class="form-control mb-2" placeholder="Utilidad final" />
                                                                            <!--end::Input-->
                                                                        </div>
                                                    ...
                                                    <!--end::Tab pane-->
                                                    <!--begin::Tab pane-->
                                                    <div class="tab-pane fade" id="kt_ecommerce_add_product_envios" role="tab-panel">
                                                        <div class="d-flex flex-column gap-7 gap-lg-10">
                                                            <!--begin::Inventory-->
                                                            <div class="card card-flush py-4">
                                                                <!--begin::Card header-->
                                                                ...
                                                                <div class="card-body pt-0">
                                                                    ...
                                                                    <div class="mb-10 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="required form-label">Peso</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input type="text" name="envio_peso" id="envio_peso" class="form-control mb-2" placeholder="Peso artículo"/>
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <!--end::Input group-->
                                                                    <!--begin::Input group-->
                                                                    <div class="mb-10 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="required form-label">Medida Largo</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input type="text" name="envio_medida_largo" id="envio_medida_largo" class="form-control mb-2" placeholder="Medida Largo" />
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <!--end::Input group-->
                                                                    <!--begin::Input group-->
                                                                    <div class="mb-10 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="required form-label">Medida Ancho</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input type="text" name="envio_medida_ancho" id="envio_medida_ancho" class="form-control mb-2" placeholder="Medida Ancho" />
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <!--end::Input group-->
                                                                    <!--begin::Input group-->
                                                                    <div class="mb-10 fv-row">
                                                                        <!--begin::Label-->
                                                                        <label class="required form-label">Medida Alto</label>
                                                                        <!--end::Label-->
                                                                        <!--begin::Input-->
                                                                        <input type="text" name="envio_medida_alto" id="envio_medida_alto" class="form-control mb-2" placeholder="Medida Alto" />
                                                                        <!--end::Input-->
                                                                    </div>
                                                                    <!--end::Input group-->
                                                                </div>
                                                ...
                                                <!--end::Tab content-->
                                                <!--begin::Tab pane-->
                                                <div class="tab-pane fade" id="kt_ecommerce_add_product_etiquetas" role="tab-panel">
                                                    <div class="d-flex flex-column gap-7 gap-lg-10">
                                                        <!--begin::Inventory-->
                                                        <div class="card card-flush py-4">
                                                            <!--begin::Card header-->
                                                                    ...
                                                                    <div class="card card-flush py-4">
                                                                        ...
                                                                        <div class="card-body pt-0">
                                                                            ...
                                                                            <div class="mb-10 fv-row">
                                                                                ...
                                                                                <!--end::Label-->
                                                                                <!--begin::Select2-->
                                                                                <input class="form-control mb-2" type="text" id="id_kt_ecommerce_add_producto_etiqueta">
                                                                                <!--end::Select2-->
                                                                            </div>
                                                                            <!--end::Input group-->
                                                                            <!--begin::Input group-->
                                                                            <div class="mb-10 fv-row">
                                                                                <!--begin::Label-->
                                                                                <label class="form-label">Tipo Etiqueta</label>
                                                                                <!--end::Label-->
                                                                                <!--begin::Select2-->
                                                                                <select class="form-select mb-2" data-control="select2" data-hide-search="true" data-placeholder="Select an option" id="select_kt_ecommerce_add_producto_etiqueta">
                                                                                    <option value="-1" selected="selected">Seleccionar tipo de etiqueta</option>
                                                                                    <option value="informacion">Informativo (Azul)</option>
                                                                                    <option value="neutro">Neutro (Negro)</option>
                                                                                    <option value="Oferta">Oferta (Rojo)</option>
                                                                                    <option value="alerta">Alerta (Amarillo)</option>
                                                                                </select>
                                                                                <!--end::Select2-->
                                                                            </div>
                                                                            <!--end::Input group-->
                                                                            <a href="javascript:void(0)" onclick="agregar_etiqueta(this);" id="kt_ecommerce_add_producto_etiqueta" class="btn btn-primary me-5">Agregar Variante</a>
                                                                            <div>
                                                                                <table style="width: 100%;">
                                                                                    <thead>
                                                                                        <tr>
                                                                                    ...
                                                                                    <tbody id="body_kt_ecommerce_add_producto_etiqueta">
                                                                                    </tbody>
                                                                                </table>
                                                                            </div>
                                                                        </div>
        ...
        <script src="assets/js/custom/apps/erp/compra_venta/compra_venta.js"></script>
        <script src="assets/js/custom/apps/ecommerce/catalog/productos.js"></script>
        <script src="assets/js/custom/apps/ecommerce/catalog/categorias.js"></script>
        <script src="assets/js/custom/apps/ecommerce/catalog/marcas.js"></script>
        <script src="assets/js/custom/apps/erp/proveedores/proveedores.js"></script>
        <script src="assets/js/custom/apps/ecommerce/catalog/editar_producto.js"></script>
        <script src="assets/js/custom/apps/erp/utilidad/utilidad_producto.js"></script>
