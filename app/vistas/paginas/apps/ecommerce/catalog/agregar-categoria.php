...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="categoria_nombre" id="categoria_nombre" class="form-control mb-2" placeholder="Product name" value="Filtro cascada 950 l/h" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
        ...
        <!--end::Javascript-->
        <!--end::Custom Javascript Categoria-->
        <script src="assets/js/custom/apps/ecommerce/catalog/categorias.js"></script>
        <script src="assets/js/custom/apps/ecommerce/catalog/agregar_categoria.js"></script>
        <!--end::Javascript-->
    </body>
    <!--end::Body-->
</html>