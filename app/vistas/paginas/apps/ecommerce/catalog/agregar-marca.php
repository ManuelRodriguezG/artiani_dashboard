...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="required form-label">Nombre de la Marca</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="categoria_nombre" id="categoria_nombre" class="form-control mb-2" placeholder="Nombre de la marca" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
        ...
        <script src="assets/js/custom/apps/ecommerce/catalog/agregar_marca.js"></script>
        <!--end::Javascript-->
    </body>
    <!--end::Body-->
</html> 