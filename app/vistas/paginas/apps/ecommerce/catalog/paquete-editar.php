...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="producto_nombre" id="producto_nombre" class="form-control mb-2" placeholder="Product name"/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    ...
                                                                    <table class="table align-middle table-row-dashed fs-6 gy-5" id="kt_ecommerce_edit_order_product_table">
                                                                        ...
                                                                        <tbody class="fw-semibold text-gray-600" id="pedido_productos">
                                                                            <tr class="odd">
                                                                                ...
                                                                                <!--begin::Product=-->
                                                                                <td>
                                                                                    <div class="d-flex align-items-center" data-kt-ecommerce-edit-order-filter="product" data-producto-descuento="0.00" data-producto-iva="13.6" data-producto-precio="85" data-producto-nombre="Alimento churro blanco sunny" data-kt-ecommerce-edit-order-id="5" data-codigo-interno="ALTO-23" data-codigo-proveedor="NULL" data-codigo-barras="AcuAli46186">
                                                                                        <!--begin::Thumbnail-->
                                                                                        <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="symbol symbol-50px">
                                                                                            <span class="symbol-label" style="background-image:url('media/apps/ecommerce/productos/5/1668228470.jpg');"></span>
                                                                                        </a>
                                                                                        <!--end::Thumbnail-->
                                                                                        <div class="ms-5">
                                                                                            <!--begin::Title-->
                                                                                            <a href="../../demo1/dist/apps/ecommerce/catalog/edit-product.html" class="text-gray-800 text-hover-primary fs-5 fw-bold">Alimento churro blanco sunny</a>
                                                                                            <!--end::Title-->
                                                                                            <!--begin::Price-->
                                                                                            <div class="fw-semibold fs-7">Price: $
                                                                                                <span data-kt-ecommerce-edit-order-filter="price">85</span></div>
                                                                                            <!--end::Price-->
                                                                                            <!--begin::SKU-->
                                                                                            <div class="text-muted fs-7">SKU: NULL</div>
                                                                                            <!--end::SKU-->
                                                                                        </div>
                                                                                    </div>
                                                                                </td>
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="price" id="precio_base" class="form-control mb-2" placeholder="Product price" value="124" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_unico" id="codigo_unico" class="form-control mb-2" placeholder="Código único"/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_interno" id="codigo_interno" class="form-control mb-2" placeholder="Código único"/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa el código único del producto</div>
                                                                    <!--end::Description-->
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_barras" id="codigo_barras" class="form-control mb-2" placeholder="Código de barras"/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
        ...
        <script src="assets/js/custom/apps/ecommerce/catalog/paquetes.js"></script>
        <script src="assets/js/custom/apps/ecommerce/catalog/paquete-editar.js"></script>
