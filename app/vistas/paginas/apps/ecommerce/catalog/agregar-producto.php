...
<html lang="en">
    ...
    <body id="kt_app_body" data-kt-app-layout="dark-sidebar" data-kt-app-header-fixed="true" data-kt-app-sidebar-enabled="true" data-kt-app-sidebar-fixed="true" data-kt-app-sidebar-hoverable="true" data-kt-app-sidebar-push-header="true" data-kt-app-sidebar-push-toolbar="true" data-kt-app-sidebar-push-footer="true" data-kt-app-toolbar-enabled="true" class="app-default">
                                        ...
                                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Select2-->
                                                    <select class="form-select mb-2" id="proveedores" data-control="select2" data-placeholder="Select an option" data-allow-clear="true" multiple="multiple">
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="producto_nombre" id="producto_nombre" class="form-control mb-2" placeholder="Product name" value="Filtro cascada 950 l/h" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="price" id="precio_base" class="form-control mb-2" placeholder="Product price" value="850" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_unico" id="codigo_unico" class="form-control mb-2" placeholder="Código único" value="SHF-1000" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_barras" id="codigo_barras" class="form-control mb-2" placeholder="Código de barras" value="7501325468542" />
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--begin::Input-->
                                                                    <div class="d-flex gap-3">
                                                                        <input type="number" name="existencia" id="existencia" class="form-control mb-2" placeholder="Existencia" value="5"/>
                                                                        <!--<input type="number" name="warehouse" class="form-control mb-2" placeholder="In warehouse" />-->
                                                                    </div>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
        ...
        <script src="assets/js/custom/apps/ecommerce/catalog/agregar_producto.js"></script>
        <!--end::Javascript-->
    </body>
    <!--end::Body-->
</html>