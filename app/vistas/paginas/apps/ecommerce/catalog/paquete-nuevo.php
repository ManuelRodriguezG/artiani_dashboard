                                        ...
                                        <div class="d-flex flex-column gap-7 gap-lg-10 w-100 w-lg-300px mb-7 me-lg-10">
                                            ...
                                            <div class="card card-flush py-4">
                                                ...
                                                <div class="card-body pt-0">
                                                    ...
                                                    <!--end::Label-->
                                                    <!--begin::Select2-->
                                                    <select class="form-select mb-2" id="categorias" data-control="select2" data-placeholder="Selecciona una opción" data-allow-clear="true" multiple="multiple">
                                                        <option></option>

                                                    </select>
                                                    <!--end::Select2-->
                                                    <!--begin::Description-->
                                                    <div class="text-muted fs-7 mb-7">Agrega una categoria al paquete</div>
                                                    <!--end::Description-->
                                                    <!--end::Input group-->
                                                    <!--begin::Button-->
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    <!--begin::Label-->
                                                                    <label class="required form-label">Nombre del paquete</label>
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="paquete_nombre" id="paquete_nombre" class="form-control mb-2" placeholder="Nombre del paquete"/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">El nombre del paquete es requerido y preferentemente único</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Editor-->
                                                                    <div id="kt_ecommerce_add_package_description" name="kt_ecommerce_add_package_description" class="min-h-200px mb-2">
                                                                    </div>
                                                                    <!--end::Editor-->
                                                                    <!--begin::Description-->
...
<!--                                                            <a href="../../demo1/dist/apps/ecommerce/catalog/add-category.html" class="btn btn-light-primary btn-sm mb-10">
                                                                ...
                                                                Agregar producto elegible 
                                                            </a>-->
                                                            <!--end::Button-->
                                                            <!--begin::Card header-->
<!--                                                            <div class="card-header">
                                                                <div class="card-title">
                                                                    <h2 class="producto_elegible">Selecciona producto elegible 1</h2>
                                                                </div>
                                                            </div>-->
                                                            <!--end::Card header-->
                                                            <!--begin::Card body-->
<!--                                                            <div class="card-body pt-0">
                                                                <div class="d-flex flex-column gap-10">
                                                                    ...
                                                                    <div>
                                                                        begin::Label
                                                                        <label class="required form-label">Nombre del producto elegible</label>
                                                                        end::Label
                                                                        begin::Input
                                                                        <input type="text" name="paquete_nombre" id="elegible_nombre" class="form-control mb-2" placeholder="Nombre del paquete"/>
                                                                        end::Input
                                                                        begin::Label
                                                                        <label class="form-label">Agregar productos para la venta</label>
                                                                        end::Label
                                                        ...
                                                        <div class="card card-flush py-4">
                                                            ...
                                                            <div class="card-body pt-0">
                                                                ...
                                                                <div class="mb-10 fv-row">
                                                                    ...
                                                                    <!--end::Label-->
                                                                    <!--begin::Input-->
                                                                    <input type="text" name="codigo_interno" id="codigo_interno" class="form-control mb-2" placeholder="Código interno"/>
                                                                    <!--end::Input-->
                                                                    <!--begin::Description-->
                                                                    <div class="text-muted fs-7">Ingresa el código interno del producto</div>
                                                                    <!--end::Description-->
                                                                </div>
                                                                <!--end::Input group-->
                                                                <!--begin::Input group-->
        ...
        <script src="assets/js/custom/apps/ecommerce/catalog/paquete-nuevo.js"></script>
