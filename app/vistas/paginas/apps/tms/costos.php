...
<head>
    ...
    <!--
      ...
      Proposito: pantalla base para costos y bonificaciones logisticas TMS.
      Impacto: TMS Delivery y Finanzas; separa cobro logistico del valor del producto.
      Contrato: vista protegida por `tms.costos`; sin escritura en fase actual.
    -->
</head>
                ...
                <div class="d-flex flex-column flex-column-fluid">
                    <div class="app-toolbar py-3 py-lg-5">
                        <div class="app-container container-fluid">
                            <h1 class="page-heading text-dark fw-bold fs-3 mb-1">Costos logisticos</h1>
                            <span class="text-muted">Cobros, costos reales y cortesias autorizadas</span>
                        </div>
                    </div>
