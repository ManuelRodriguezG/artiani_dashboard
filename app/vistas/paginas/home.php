...
<html lang="en">
                                            ...
                                            <div class="card card-flush h-md-100">
                                                ...
                                                <div class="card-header pt-7">
                                                    ...
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-gray-800">Productos más vendidos</span>
                                                        <span class="text-gray-400 mt-1 fw-semibold fs-6">hace 7 días</span>
                                                    </h3>
                                                    <!--end::Title-->
                                                </div>
                                                <!--end::Header-->
                                                ...
                                                <div class="card-body pt-6">
                                                    ...
                                                    <div class="table-responsive">
                                                        <!--begin::Table-->
                                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0" id="tabla_productos_mas_visitados">
                                                            <!--begin::Table head-->
                                                            <thead>
                                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                                    <th class="p-0 pb-3 min-w-175px text-start">ID</th>
                                                                    <th class="p-0 pb-3 min-w-100px text-end">CANTIDAD</th>
                                                                    <th class="p-0 pb-3 min-w-100px text-end">TIPO</th>
                                                                    <th class="p-0 pb-3 min-w-175px text-end pe-12">NOMBRE</th>

                                                                </tr>
                                                            </thead>
                                                            <!--end::Table head-->
                                                            <!--begin::Table body-->
                                                            <tbody id="body_productos_visitados">
                                                                <tr>
                                                                    ...
                                                                    <td class="text-end pe-0">
                                                                        <span class="text-gray-600 fw-bold fs-6">Producto</span>
                                                                    </td>
                                                                    <td class="text-end pe-0">
                                                                        <span class="text-gray-800 fw-bold text-hover-primary mb-1 fs-6">Filtro cascada 950 l/h</span>
                                                                    </td>
                                                                </tr>
                                                            </tbody>
                                                            <!--end::Table body-->
                                        ...
                                        <div class="col-xl-6">
                                            ...
                                            <div class="card card-flush h-md-100">
                                                ...
                                                <div class="card-header pt-7">
                                                    <!--begin::Title-->
                                                    <h3 class="card-title align-items-start flex-column">
                                                        <span class="card-label fw-bold text-gray-800">Pedidos</span>
                                                        <span class="text-gray-400 mt-1 fw-semibold fs-6">hace 7 días</span>
                                                    </h3>
                                                    <!--end::Title-->
                                                </div>
                                                ...
                                                <div class="card-body pt-6">
                                                    ...
                                                    <div class="table-responsive">
                                                        <!--begin::Table-->
                                                        <table class="table table-row-dashed align-middle gs-0 gy-3 my-0" id="pedidos_nuevos">
                                                            <!--begin::Table head-->
                                                            <thead>
                                                                <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                                    <th class="p-0 pb-3 min-w-175px text-start">ID</th>
                                                                    <th class="p-0 pb-3 min-w-100px text-end">NOMBRES</th>
                                                                    <th class="p-0 pb-3 min-w-100px text-end">TOTAL</th>
                                                                    <th class="p-0 pb-3 min-w-175px text-end pe-12">FECHA<S/th>

                                                            </tr>
                                                        </thead>
                                                        <!--end::Table head-->
                                                        <!--begin::Table body-->
                                                        <tbody id="body_pedidos_nuevos">
                                                            <tr>
                                                                <td class="text-end pe-0">
                                                                    <span class="text-gray-600 fw-bold fs-6">1</span>
                                                                </td>
                                    ...
                                    <div class="col-xl-6">
                                        ...
                                        <div class="card card-flush h-md-100">
                                            ...
                                            <div class="card-header pt-7">
                                                <!--begin::Title-->
                                                <h3 class="card-title align-items-start flex-column">
                                                    <span class="card-label fw-bold text-gray-800">Prospectos</span>
                                                    <span class="text-gray-400 mt-1 fw-semibold fs-6">hace 7 días</span>
                                                </h3>
                                                <!--end::Title-->
                                            </div>
                                            ...
                                            <div class="card-body pt-6">
                                                ...
                                                <div class="table-responsive">
                                                    <!--begin::Table-->
                                                    <table class="table" id="tabla_prospectos">
                                                        <!--begin::Table head-->
                                                        <thead>
                                                            <tr class="fs-7 fw-bold text-gray-400 border-bottom-0">
                                                                <th class="p-0 pb-3 min-w-175px text-start">ID</th>
                                                                <th class="p-0 pb-3 min-w-100px text-end">NOMBRES</th>
                                                                <th class="p-0 pb-3 min-w-100px text-end">FECHA</th>
                                                            </tr>
                                                        </thead>
                                                        <!--end::Table head-->
                                                        <!--begin::Table body-->
                                                        <tbody id="body_prospectos">
                                                            <tr>
                                                                <td class="text-end pe-0">
                                                                    <span class="text-gray-600 fw-bold fs-6">1</span>
                                                                </td>
    ...
    <script src="assets/js/custom/pages/inicio/vendidos.js"></script>
    <script src="assets/js/custom/pages/inicio/tablas_vendidos.js"></script>
    <script src="assets/js/custom/pages/inicio/pedidos.js"></script>
    <script src="assets/js/custom/pages/inicio/tablas_pedidos.js"></script>
    <script src="assets/js/custom/pages/inicio/prospectos.js"></script>
    <script src="assets/js/custom/pages/inicio/tablas_prospectos.js"></script>
