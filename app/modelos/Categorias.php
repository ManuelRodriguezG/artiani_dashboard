...
class Categorias extends CRUD {
    ...
    private $recursos_categorias = "media/apps/ecommerce/categorias/";
    private $identificador_categoria;
    private $tabla_categorias_destacadas = "ecom_categorias_destacadas";
    private $tabla_productos = "ecom_productos";
    private $tabla_productos_categorias = "ecom_productos_categorias";
    ...
    public function registrar() {
        ...
        $this->setTabla($this->tabla_categorias);
    ...
    public function guardar_imagenes() {
        $urlRecursos = $this->recursos_categorias . $this->getId_categoria() . "/";
...
//    }
    ...
    public function consultar_productos_categoria() {
        ...
        $this->setAnd("ecomp.tipo = 'producto'");
        $this->setColumnas($campos);
...
//    var_dump($valores_registrar);
        ...
        $this->setWhere("id_categoria = " . $this->getId_categoria());
