...
class SistemaConfiguracionEsquema extends DBSchema {
  ...
  private function semillasConfiguracion($ejecutar) {
    $semillas = array(
      ...
      array("grupo" => "branding", "clave" => "branding.logo_login", "tipo_dato" => "ruta", "valor" => "/assets/media/logos/default-dark.svg", "descripcion" => "Logo para pantalla de inicio de sesion sobre fondo claro"),
      ...
      array("grupo" => "branding", "clave" => "branding.login_titulo", "tipo_dato" => "texto", "valor" => "Iniciar sesion", "descripcion" => "Titulo principal mostrado en la pantalla de login"),
      array("grupo" => "branding", "clave" => "branding.login_subtitulo", "tipo_dato" => "texto", "valor" => "Acceso al panel operativo", "descripcion" => "Texto de apoyo mostrado bajo el titulo de login"),
