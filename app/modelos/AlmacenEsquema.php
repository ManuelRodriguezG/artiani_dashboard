...
class AlmacenEsquema extends DBSchema {
    ...
    public function columnasAlmacenInventario() {
        return array(
            ...
            "erp_almacen_resurtido_envios" => array(
                ...
                "id_resurtido_preparacion",
                "id_movimiento_salida",
                "id_movimiento_transito_entrada",
                "id_existencia_transito",
                "id_inventario_unidad",
                "cantidad_enviada",
                "estatus",
                "enviado_por",
            ...
            "erp_almacen_resurtido_recepciones" => array(
                "id_resurtido_recepcion",
                "id_resurtido_almacen",
                "id_resurtido_envio",
                "id_almacen_destino",
                "ubicacion_destino_id",
                "id_movimiento_transito_salida",
                "id_movimiento_entrada_destino",
    ...
    public function indicesAlmacenInventario() {
        return array(
            ...
            "erp_inventario_politicas_almacen_sku" => array(
                "uk_inv_politica_almacen_sku",
                "idx_inv_politica_sku",
                "idx_inv_politica_estatus"
            ),
            "erp_almacen_resurtidos" => array(
                "uk_alm_resurtido_folio",
                "idx_alm_resurtido_solicitante",
                "idx_alm_resurtido_origen",
                "idx_alm_resurtido_transito",
                "idx_alm_resurtido_estatus",
                "idx_alm_resurtido_fecha"
            ),
            "erp_almacen_resurtido_detalle" => array(
                "idx_res_det_resurtido",
                "idx_res_det_sku",
                "idx_res_det_estatus"
            ),
            "erp_almacen_resurtido_preparacion" => array(
                "idx_res_prep_resurtido",
                "idx_res_prep_detalle",
                "idx_res_prep_existencia",
                "idx_res_prep_unidad",
                "idx_res_prep_sku"
            ),
            "erp_almacen_resurtido_envios" => array(
                "idx_res_env_resurtido",
                "idx_res_env_preparacion",
                "idx_res_env_salida",
                "idx_res_env_transito",
                "idx_res_env_unidad"
            ),
            "erp_almacen_resurtido_recepciones" => array(
                "idx_res_rec_resurtido",
                "idx_res_rec_envio",
                "idx_res_rec_destino",
                "idx_res_rec_existencia",
                "idx_res_rec_unidad"
            ),
            "erp_almacen_resurtido_diferencias" => array(
                "idx_res_dif_resurtido",
                "idx_res_dif_detalle",
                "idx_res_dif_envio",
                "idx_res_dif_recepcion",
                "idx_res_dif_tipo",
                "idx_res_dif_estatus",
                "idx_res_dif_sku",
                "idx_res_dif_unidad"
    ...
    public function fksAlmacenInventario() {
        return array(
            ...
            "erp_almacen_resurtidos" => array(
                "fk_res_alm_solicitante",
                "fk_res_alm_origen",
                "fk_res_alm_transito"
            ),
            "erp_almacen_resurtido_detalle" => array(
                "fk_res_det_resurtido",
                "fk_res_det_sku"
            ),
            "erp_almacen_resurtido_preparacion" => array(
                "fk_res_prep_resurtido",
                "fk_res_prep_detalle",
                "fk_res_prep_existencia",
                "fk_res_prep_unidad",
                "fk_res_prep_almacen",
                "fk_res_prep_sku"
            ),
            "erp_almacen_resurtido_envios" => array(
                "fk_res_env_resurtido",
                "fk_res_env_preparacion",
                "fk_res_env_mov_salida",
                "fk_res_env_mov_transito",
                "fk_res_env_existencia_transito",
                "fk_res_env_unidad"
            ),
            "erp_almacen_resurtido_recepciones" => array(
                "fk_res_rec_resurtido",
                "fk_res_rec_envio",
                "fk_res_rec_almacen",
                "fk_res_rec_mov_transito",
                "fk_res_rec_mov_entrada",
                "fk_res_rec_existencia",
                "fk_res_rec_unidad"
            ),
            "erp_almacen_resurtido_diferencias" => array(
                "fk_res_dif_resurtido",
                "fk_res_dif_detalle",
                "fk_res_dif_envio",
    ...
    public function planActualizarAlmacenInventario($ejecutar = false) {
        ...
        // Resurtido y traspasos documentales entre tiendas. Propuesta inicial:
        // solicitud, preparacion, transito, recepcion y diferencias. No sustituye
        // el traspaso directo de Inventario; lo envuelve con flujo operativo.
        $plan[] = $this->crearTablaSiNoExiste("erp_inventario_politicas_almacen_sku", array(
        ...
        $plan[] = $this->crearTablaSiNoExiste("erp_almacen_resurtidos", array(
        ...
        $plan[] = $this->crearTablaSiNoExiste("erp_almacen_resurtido_detalle", array(
        ...
        $plan[] = $this->crearTablaSiNoExiste("erp_almacen_resurtido_preparacion", array(
        ...
        $plan[] = $this->crearTablaSiNoExiste("erp_almacen_resurtido_envios", array(
        ...
        $plan[] = $this->crearTablaSiNoExiste("erp_almacen_resurtido_recepciones", array(
        ...
        $plan[] = $this->crearTablaSiNoExiste("erp_almacen_resurtido_diferencias", array(
