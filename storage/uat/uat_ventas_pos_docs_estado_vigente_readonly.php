...
$docs = array(
    ...
    "estado_cierre_modulo" => array(
        ...
        "tokens" => array(
            ...
            "pendientes_total=5" => "total vigente de pendientes piloto",
            "USUARIO_NOMBRE_VISUAL" => "correccion visual de usuario pendiente",
            "uat_ventas_pos_piloto_plan_accion_readonly.php" => "plan de accion piloto documentado",
            "acciones_total=7" => "acciones vigentes del plan piloto",
            ...
            "scripts_total=26" => "total vigente cierre ampliado",
    ...
    "guia_primer_turno" => array(
        ...
        "tokens" => array(
            ...
            "scripts_total=26" => "total checks cierre ampliado en guia",
            "Ventas > Manual POS" => "manual POS en guia",
            "acciones_total=7" => "acciones plan en guia",
    ...
    "salida_operacion_controlada" => array(
        ...
        "tokens" => array(
            ...
            "acciones_total=7" => "acciones vigentes",
