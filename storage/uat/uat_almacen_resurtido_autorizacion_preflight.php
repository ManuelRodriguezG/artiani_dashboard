...
$archivos = array(
    ...
    "uat_autorizar_authorized" => "storage/uat/uat_almacen_resurtido_autorizar_authorized.php",
    "uat_cancelar_authorized" => "storage/uat/uat_almacen_resurtido_cancelar_authorized.php",
    "uat_politica_authorized" => "storage/uat/uat_almacen_resurtido_politica_authorized.php",
    ...
    "uat_plan_preparacion_readonly" => "storage/uat/uat_almacen_resurtido_plan_preparacion_readonly.php",
    "uat_payload_preparacion_envio_readonly" => "storage/uat/uat_almacen_resurtido_payload_preparacion_envio_readonly.php",
...
echo json_encode(array(
    ...
    "tokens" => array(
        ...
        "autorizar_autorizar" => "ALMACEN_RESURTIDO_AUTORIZAR_UAT",
        "autorizar_confirmacion" => "AUTORIZO UAT AUTORIZAR RESURTIDO usando respaldo RUTA_O_REFERENCIA",
        "cancelar_autorizar" => "ALMACEN_RESURTIDO_CANCELAR_UAT",
        "cancelar_confirmacion" => "AUTORIZO UAT CANCELAR RESURTIDO usando respaldo RUTA_O_REFERENCIA",
        "politica_autorizar" => "ALMACEN_RESURTIDO_POLITICA_UAT",
        "politica_confirmacion" => "AUTORIZO UAT POLITICA RESURTIDO usando respaldo RUTA_O_REFERENCIA",
    ...
    "secuencia_autorizada" => array(
        ...
        "7_autorizar_folio_uat" => "C:\\xampp\\php\\php.exe storage\\uat\\uat_almacen_resurtido_autorizar_authorized.php --autorizar=ALMACEN_RESURTIDO_AUTORIZAR_UAT --confirmacion=\"AUTORIZO UAT AUTORIZAR RESURTIDO usando respaldo RUTA_O_REFERENCIA\" --respaldo=RUTA_O_REFERENCIA_RESPALDO --folio=RES-YYYYMMDD-#### --accion=autorizar",
        "8_preflight_preparacion_envio" => "C:\\xampp\\php\\php.exe storage\\uat\\uat_almacen_resurtido_preparacion_envio_preflight.php --folio=RES-YYYYMMDD-####",
        "9_plan_preparacion_readonly" => "C:\\xampp\\php\\php.exe storage\\uat\\uat_almacen_resurtido_plan_preparacion_readonly.php --folio=RES-YYYYMMDD-####",
        "10_payload_preparacion_envio_readonly" => "C:\\xampp\\php\\php.exe storage\\uat\\uat_almacen_resurtido_payload_preparacion_envio_readonly.php --folio=RES-YYYYMMDD-####",
        "11_preflight_recepcion_diferencias" => "C:\\xampp\\php\\php.exe storage\\uat\\uat_almacen_resurtido_recepcion_diferencias_preflight.php --folio=RES-YYYYMMDD-####"
    ),
    "guardrails" => array(
        "no_ejecuta_ddl" => true,
        "no_escribe_bd" => true,
