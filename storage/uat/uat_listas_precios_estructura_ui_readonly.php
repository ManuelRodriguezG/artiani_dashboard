...
$checks = array(
    ...
    checkEstructura("editor_guardado_estado_confirmado", contieneEstructura($jsEditor, array("parseResponseJson", "confirmar_activacion", "estatusAnterior", "onError")) && contieneEstructura($jsEditor, array("Respuesta no valida del servidor", "actualizarBotonesEstatus")), "Activar lista solo conserva estatus si backend confirma y muestra errores HTTP/CSRF claros"),
    checkEstructura("editor_publico_general_sin_cliente", contieneEstructura($editor, array("Cobertura y excepciones", "Publico general", "no agregues clientes", "Se llena al elegir un cliente")) && contieneEstructura($jsEditor, array("Publico general, sin cliente requerido", "no requiere asignar clientes")), "UI aclara que una lista general no requiere cliente ni IDs"),
    ...
    checkEstructura("productos_costo_central", contieneEstructura(leerEstructura($raiz, "app/modelos/ListasPreciosErp.php"), array("RentabilidadErp", "resolverCostoVigenteSku", "costo_confianza", "costo_formula", "costoComercialDetalle")), "Productos consume costo vigente central de Rentabilidad en read-only"),
    checkEstructura("productos_costo_fuente_ui", contieneEstructura($jsEditor, array("costoComercialHtml", "costo_fuente_label", "costo_confianza", "costo_formula")), "UI muestra fuente, confianza y formula del costo usado para margen"),
    checkEstructura("productos_costo_proveedor_normalizado", contieneEstructura(leerEstructura($raiz, "app/modelos/RentabilidadErp.php"), array("normalizarCostoProveedorVigente", "costo_original_proveedor", "factor_conversion", "tipo_cambio_referencia")) && contieneEstructura(leerEstructura($raiz, "app/modelos/ListasPreciosErp.php"), array("factor_conversion", "tipo_cambio_referencia", "costo_proveedor")), "Costo proveedor vigente conserva costo original y normaliza por factor/tipo de cambio para margen"),
    checkEstructura("productos_imagen_visible", contieneEstructura($editor, array("lp-product-img", "Foto")) && contieneEstructura($jsEditor, array("imagenProductoHtml", "normalizarImagenUrl", "url_imagen")) && contieneEstructura(leerEstructura($raiz, "app/modelos/ListasPreciosErp.php"), array("erp_catalogo_imagenes", "url_imagen", "tipo_imagen")), "Mesa de precios muestra foto activa de Catalogo cuando exista"),
    ...
    checkEstructura("plan_documenta", contieneEstructura($plan, array("Estructura UI 2026-07-20", "listas_precios_nueva", "listas_precios_editar", "Costo proveedor normalizado 2026-08-21")), "Plan vivo documenta separacion UI y costo proveedor normalizado")
);
