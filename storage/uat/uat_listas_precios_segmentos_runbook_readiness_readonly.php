...
$archivos = array(
    ...
    "docs/erp_mysql_xampp_recuperacion_runbook.md",
    "storage/uat/uat_mysql_xampp_health_readonly.php",
    ...
    "storage/uat/uat_listas_precios_guardado_masivo_ui_readonly.php",
    "storage/uat/uat_listas_precios_lote_guardado_resumen_ui_readonly.php",
    "storage/uat/uat_listas_precios_flujo_guiado_ui_readonly.php",
    "storage/uat/uat_listas_precios_productos_mesa_ui_readonly.php",
    "storage/uat/uat_listas_precios_manual_readiness_readonly.php",
    "storage/uat/uat_listas_precios_estructura_ui_readonly.php",
    "storage/uat/uat_listas_precios_fase1_entregable_readonly.php",
    "storage/uat/uat_listas_precios_fase1_readiness_model_readonly.php",
    "storage/uat/uat_listas_precios_piloto_pos_readonly.php",
    "storage/uat/uat_listas_precios_pos_venta_snapshot_readonly.php",
    ...
    "storage/uat/uat_listas_precios_filtros_margen_readonly.php",
    "storage/uat/uat_listas_precios_resolutor_conexion_guard_readonly.php",
    "storage/uat/uat_listas_precios_revision_comercial_ui_readonly.php",
