...
$checks = array(
    "vista_pos" => array(
        ...
        "pos-shortcut-strip" => "resumen visible de atajos junto al buscador",
        "Escanear con camara (F3)" => "boton de camara POS con atajo visible",
        ...
        "Alt+4" => "atajo visible para pago con saldo cliente",
        "pos_compromiso_wrap" => "compromiso ocultable por tipo de documento",
        "pos_turno_cta" => "aviso operativo para abrir turno antes de cobrar",
    ...
    "js_pos" => array(
        ...
        "limpiarTicketCliente" => "ticket cliente sin mensajes internos de sistema",
        "Avisos para operador" => "bloqueos visibles fuera del ticket para cajero/supervisor",
        "Los avisos de operacion no se imprimen" => "ticket preview separa cliente de validaciones internas",
        "actualizarVisibilidadDocumento" => "visibilidad de compromiso por venta/pedido",
        "mensajeOperativo" => "traduccion de mensajes tecnicos a instrucciones de operador",
        "Pendientes por resolver" => "validaciones visibles con lenguaje operativo",
    ...
    "manual" => array(
        ...
        "Decision rapida en mostrador" => "matriz operativa de decision en mostrador",
        ...
        "Minimo para iniciar en local" => "minimo operativo para arranque local",
        "Venta rapida controlada" => "venta rapida controlada explicada",
        "Agregar una venta rapida al carrito no genera alerta operativa" => "venta rapida alerta solo al cobro",
        "Producto por clasificar" => "producto no catalogado queda como pendiente de catalogo",
        "Pendiente para Catalogo ERP" => "alerta/pendiente hacia Catalogo ERP",
        ...
        "La alerta real se crea al cobrar" => "inventario pendiente alerta solo al cobro",
