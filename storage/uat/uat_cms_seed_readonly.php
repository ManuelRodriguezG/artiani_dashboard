 ...
 * Proposito: validar semilla base CMS ecommerce despues de aplicar DDL.
 * Impacto: confirma estructura inicial en BD sin activar escrituras del panel ni modificar API publica.
...
$conteos = array(
  ...
  "bloques_comerciales" => contarCmsSeed($db, "SELECT COUNT(*) FROM erp_ecommerce_contenido_bloques"),
  "publicaciones_contenido" => contarCmsSeed($db, "SELECT COUNT(*) FROM erp_ecommerce_contenido_publicaciones"),
...
if ($conteos["bloques_comerciales"] !== 0) { $bloqueos[] = "semilla_creo_bloques_comerciales"; }
if ($conteos["publicaciones_contenido"] !== 0) { $bloqueos[] = "semilla_creo_publicaciones_contenido"; }
