    ...
    let code = `
        <tr>
                            ...
                            <td data-kt-ecommerce-order-filter="order_id">
                              <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">${venta.id_pedido}</a>
                            </td>
                            <!--end::Order ID=-->
                            <!--begin::Customer=-->
                            <td>
                            ...
                            <td class="text-end pe-0" data-order="Completed">
                              <!--begin::Badges-->
                              ${venta.estatus == 0 ? '<div class="badge badge-light-primary">Nueva</div>' : '<div class="badge badge-light-success">Finalizada</div>'}
                              <!--end::Badges-->
                            </td>
                            <!--end::Status=-->
                            <!--begin::Total=-->
                            <td class="text-end pe-0">
                              <span class="fw-bold">$${venta.total}</span>
                            </td>
                            <!--end::Total=-->
                            <!--begin::Fecha=-->
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.fch_r}</span>
                            </td>
                            <!--end::Fecha=-->
                            <!--begin::Action=-->
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                  <a href="/ventas/editar/${venta.id_pedido}" class="menu-link px-3">Editar</a>
                                </div>
                                <!--end::Menu item-->
                              </div>
                              <!--end::Menu-->
...
function obtener_ventas() {
    let respuesta = consultar_ventas();
    console.log(respuesta);
    if (respuesta.error == false) {
        ui_ventas(respuesta.depurar);
    }
}

function ui_ventas(ventas) {
    let codigo_ventas = "";
