        ...
        submitButton.addEventListener('click', e => {
            ...
            if (validator) {
                validator.validate().then(function (status) {
                    ...
                    if (status == 'Valid') {
                        let info = obtener_informacion_categoria();
                        registrar_categoria(info);
...
function registrar_categoria(data) {
...
function obtener_informacion_categoria() {
    let descripcion = $("#kt_ecommerce_add_category_description").text();
    let categoria = $("#category_name").val();
