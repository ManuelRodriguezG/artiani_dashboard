...
function consultar_paquetes() {
    let data = "";
    let codigo_producto = "";
    let productos = listar_paquetes(data);
                        ...
                        <tr>
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                <!--begin::Thumbnail-->
                                <a href="/paquetes/editar/${producto.id_paquete}" class="symbol symbol-50px">
                                  <span class="symbol-label" style="background-image:url('${producto.url_imagen}');"></span>
                                </a>
                                <!--end::Thumbnail-->
                                <div class="ms-5">
                                  <!--begin::Title-->
                                  <a href="/paquetes/editar/${producto.id_paquete}" class="text-gray-800 text-hover-primary fs-5 fw-bold" data-kt-ecommerce-product-filter="product_name">
                                    ${producto.nombre}
                                   </a>
                                  <!--end::Title-->
                                </div>
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="/paquetes/editar/${producto.id_paquete}" class="menu-link px-3">Edit</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
