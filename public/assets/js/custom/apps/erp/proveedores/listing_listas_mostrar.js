    ...
    let code = `
        <tr>
                            ...
                            <td data-kt-ecommerce-order-filter="order_id">
                              <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">${venta.id_lista_proveedor}</a>
                            </td>
                            <!--end::Order ID=-->
                            <!--begin::Customer=-->
                            <td>
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.lista}</span>
                            </td>
                            <!--end::Total=-->
                            <!--begin::Status=-->
                            <td class="text-end pe-0" data-order="Completed">
                              <!--begin::Badges-->
                              ${venta.estatus == 0 ? '<div class="badge badge-light-primary">Eliminada</div>' : '<div class="badge badge-light-success">Activa</div>'}
                              <!--end::Badges-->
                            </td>
                            <!--end::Status=-->
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="/proveedor/lista_productos/${venta.id_lista_proveedor}" class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
