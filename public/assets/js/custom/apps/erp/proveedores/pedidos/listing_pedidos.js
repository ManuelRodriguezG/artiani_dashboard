                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="/proveedor/editar_pedido/${venta.id_pedido}" class="menu-link px-3">Editar</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                  <a href="/proveedor/pedido_productos/${venta.id_pedido}" class="menu-link px-3">Mostrar</a>
                                </div>
                                <!--end::Menu item-->
                              </div>
                              <!--end::Menu-->
