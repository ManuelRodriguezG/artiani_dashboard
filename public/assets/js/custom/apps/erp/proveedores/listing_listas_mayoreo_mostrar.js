    ...
    let code = `
        <tr>
                            ...
                            <td class="text-end pe-0" data-order="Completed">
                              <!--begin::Badges-->
                              ${venta.estatus == 0 ? '<div class="badge badge-light-primary">Inactiva</div>' : '<div class="badge badge-light-success">Activa</div>'}
                              <!--end::Badges-->
                            </td>
                            <!--end::Status=-->
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ${venta.estatus == 0 ? '<!--begin::Menu item--><div class="menu-item px-3"><a href="javascript:avoid(0);" onclick="cambiar_estatus_lista(this);" class="menu-link px-3" data-id-lista-mayoreo="' + venta.id_lista_mayoreo + '" data-estatus="1">Activar</a></div><!--end::Menu item-->' : '<!--begin::Menu item--><div class="menu-item px-3"><a  href="javascript:avoid(0);" onclick="cambiar_estatus_lista(this);" class="menu-link px-3" data-id-lista-mayoreo="' + venta.id_lista_mayoreo + '" data-estatus="0">Desactivar</a></div><!--end::Menu item-->'}
                              </div>
                              <!--end::Menu-->
                            </td>
                            <!--end::Action=-->
