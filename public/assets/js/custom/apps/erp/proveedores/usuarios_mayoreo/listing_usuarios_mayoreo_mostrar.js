    ...
    let code = `
        <tr>
                            ...
                            <td data-kt-ecommerce-order-filter="order_id">
                              <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">${venta.id_usuario}</a>
                            </td>
                            <!--end::Order ID=-->
                            <!--begin::Customer=-->
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ms-5">
                                  <!--begin::Title-->
                                  ${venta.nombres + " " + venta.apellido_materno + " " + venta.apellido_paterno}
                                  <!--end::Title-->
                                </div>
                              </div>
                            </td>
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.nombre_negocio}</span>
                            </td>
                            <!--end::Total=-->
                            <!--begin::Status=-->
                            <td class="text-end pe-0" data-order="Completed">
                              <!--begin::Badges-->
                              ${venta.estatus == 0 ? '<div class="badge badge-light-primary">Inactivo</div>' : '<div class="badge badge-light-success">Activo</div>'}
                              <!--end::Badges-->
                            </td>
                            <!--end::Status=-->
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/proveedor/usuario_mayoreo_listas/${venta.id_usuario}" onclick="cambiar_estatus_lista(this);" class="menu-link px-3">
                                            Asignar listas
                                        </a>
                                    </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                    <div class="menu-item px-3">
                                        <a href="/usuario/mayoreo_mostrar/${venta.id_usuario}" onclick="cambiar_estatus_lista(this);" class="menu-link px-3">
                                            Mostrar información
                                        </a>
                                    </div>
                                <!--end::Menu item-->
...
function obtener_listas_proveedores() {
    let respuesta = consultar_listas_proveedores();
...
async function cambiar_estatus_lista(elemento) {
    ...
    console.log($(elemento));
    let estatus = $(elemento).attr("data-estatus");
    ...
    let respuesta = await actualizar_estatus_lista_mayoreo(data);
    console.log(respuesta);
    if (respuesta.error == false) {
        location.reload();
    }
