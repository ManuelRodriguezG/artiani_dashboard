...
//    }
    ...
    const initDropzone = () => {
        var myDropzone = new Dropzone("#kt_ecommerce_add_product_media", {
            url: "/proveedor/registrar_lista_mayoreo", // Set the url for your upload script location
...
function obtener_informacion() {
    ...
    let descripcion = $("#producto_nombre").val();
    let siempre_disponible = $("#siempre_disponible")[0].checked;
    let precio_base = $("#precio_base").val();
    let costo_base = $("#costo_base").val();
    let codigo_unico = $("#codigo_unico").val();
