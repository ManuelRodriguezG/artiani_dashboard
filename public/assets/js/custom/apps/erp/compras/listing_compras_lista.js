    ...
    let code = `
        <tr>
                            ...
                            <td data-kt-ecommerce-order-filter="order_id">
                              <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">${venta.id_orden_de_compra}</a>
                            </td>
                            <!--end::Order ID=-->
                            <!--begin::Customer=-->
                            <td>
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="/compra/compra_productos/${venta.id_orden_de_compra}" class="menu-link px-3">View</a>
                                </div>
                                <!--end::Menu item-->
