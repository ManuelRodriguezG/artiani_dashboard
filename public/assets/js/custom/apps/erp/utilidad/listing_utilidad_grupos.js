    ...
    let code = `
        <tr>
                            ...
                            <td data-kt-ecommerce-order-filter="order_id">
                              <a href="../../demo1/dist/apps/ecommerce/sales/details.html" class="text-gray-800 text-hover-primary fw-bold">${venta.id_utilidad_grupo}</a>
                            </td>
                            <!--end::Order ID=-->
                            <!--begin::Customer=-->
                            <td>
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.porcentaje_utilidad}</span>
                            </td>
                            <!--end::Total=-->
                            <!--begin::Status=-->
                            ...
                            <td class="text-end">
                              ...
                              <div class="menu menu-sub menu-sub-dropdown menu-column menu-rounded menu-gray-600 menu-state-bg-light-primary fw-semibold fs-7 w-125px py-4" data-kt-menu="true">
                                ...
                                <div class="menu-item px-3">
                                  <a href="/utilidad/editar_grupo_utilidad/${venta.id_utilidad_grupo}" class="menu-link px-3">Editar</a>
                                </div>
                                <!--end::Menu item-->
                                <!--begin::Menu item-->
                                <div class="menu-item px-3">
                                  <a href="/utilidad/utilidad_productos/${venta.id_utilidad_grupo}" class="menu-link px-3">Mostrar</a>
                                </div>
                                <!--end::Menu item-->
                              </div>
                              <!--end::Menu-->
