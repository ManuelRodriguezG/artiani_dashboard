        ...
        <tr id="${venta.id_producto}" class="tr-item">
                            ...
                            <td>
                              <div class="d-flex align-items-center">
                                ...
                                <div class="ms-5">
                                  <!--begin::Title-->
                                  <a href="/producto/editar/${venta.nombre}" class="text-gray-800 text-hover-primary fs-5 fw-bold nombre" data-kt-ecommerce-product-filter="product_name">${venta.nombre}</a>
                                  <!--end::Title-->
                                </div>
                              </div>
                            </td>
                            ...
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.costo}</span>
                            </td>
                            <!--end::Total=-->
                            <!--begin::Total=-->
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.precio}</span>
                            </td>
                            <!--end::Total=-->
                            <!--begin::Total=-->
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.proveedor}</span>
                            </td>
                            <!--end::Total=-->
                            <!--begin::Total=-->
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.costo_actualizado}</span>
                            </td>
                            <!--end::Total=-->
                            <!--begin::Total=-->
                            <td class="text-end pe-0">
                              <span class="fw-bold">${venta.precio_actualizado}</span>
                            </td>
                            <!--end::Total=-->
                          </tr>
    `;
...
function ui_listas_proveedores(ventas) {
    let codigo_ventas = "";
    let costo_total = 0, precio_total = 0, porcentaje_anterior = 0,porcentaje_actualizado = 0,ganancia_total = 0;
    Object.entries(ventas).forEach(function (row) {
        
        porcentaje_anterior = parseFloat(row[1]['porcentaje_utilidad']);
        costo_total += parseFloat(row[1]['costo_actualizado']);
        precio_total += parseFloat(row[1]['precio_actualizado']);
    ...
    porcentaje_actualizado = ganancia_total/precio_total;
    $("#porcentaje_anterior").text(porcentaje_anterior);
    $("#porcentaje_actualizado").text(porcentaje_actualizado);
